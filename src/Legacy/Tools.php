...
class Tools
{
    ...
    public function displayPlace(string $place): string
    {
        ...
        $placelist = [
            ...
            '/forum'          => '<a href="#home#/forum/">' . _t('Forum', 'system') . '</a>&#160;/&#160;<a href="#home#/forum/?act=who">&gt;&gt;</a>', // phpcs:ignore
    ...
    public function displayUser($user = 0, array $arg = [])
    {
        ...
        if ($ipinf || $lastvisit || ! empty($arg['sub']) || isset($arg['footer'])) {
            ...
            if ($ipinf) {
                $out .= '<div><span class="gray">' . _t('Browser', 'system') . ':</span> ' .
                ...
                if (isset($arg['iphist'])) {
                    ...
                    $out .= '<div><span class="gray">' . _t('IP History', 'system') .
